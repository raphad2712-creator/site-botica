    ...
    <>
      ...
      <header>
        ...
        <Link className="official-logo logo-clean" href="/">
          <Image className="logo-light-image" src="/botica-logo-nova.jpeg" alt="Botica Bioenergética" width={300} height={89} priority />
          <Image className="logo-dark-image" src="/botica-logo-dark.png" alt="Botica Bioenergética" width={300} height={89} priority />
        </Link>
